...
router.post('/api/projects/save', async ({ request, user }) => {
  try {
    ...
    if(!puterUser) return jsonError(401, 'Authentication failed')
    ...
    const userId = getUserId(puterUser)
    ...
    return jsonError(500, 'Failed to save project', { message: error.message || 'Uknown error'})
  }
})
